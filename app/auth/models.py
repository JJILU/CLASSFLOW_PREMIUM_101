...
class TeacherSchoolRecord(db.Model):
    ...
    @classmethod
    def get_teacher_by_card_id(cls,teacher_school_id):
        return TeacherSchoolRecord.query.filter_by(teacher_school_id=teacher_school_id).first()    
...
class StudentSchoolRecord(db.Model):
    ...
    def __init__(self,first_name,last_name,student_school_id):
        ...
        # check if teacher id is in school records, before creating one
    @classmethod
    def get_student_by_card_id(cls,student_school_id):
        return StudentSchoolRecord.query.filter_by(student_school_id=student_school_id).first()     
...
class Teacher(db.Model,UserMixin):
    ...
    def get_teacher_card_id(cls,teacher_card_id):
        return Teacher.query.filter_by(teacher_card_id=teacher_card_id).first()
...
class Admin(db.Model,UserMixin):
    ...
    def get_admin_card_id(cls,admin_card_id):
        return Teacher.query.filter_by(admin_card_id=admin_card_id).first()
...
class Student(db.Model,UserMixin):
    ...
    def get_student_card_id(cls,student_card_id):
        return Teacher.query.filter_by(student_card_id=student_card_id).first()
